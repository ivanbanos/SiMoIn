...
@NamedQueries({
    ...
    @NamedQuery(name = "Vista.findByLabel", query = "SELECT v FROM Vista v WHERE v.label = :label")})
public class Vista implements Serializable {
    ...
    public Vista(Integer id, String nombre) {
        this.id = id;
        this.nombre = nombre;
    }
    ...
    public String toString() {
        return "com.hatapp.comandas.simoin.api.Vista[ id=" + id + " ]";
    }
